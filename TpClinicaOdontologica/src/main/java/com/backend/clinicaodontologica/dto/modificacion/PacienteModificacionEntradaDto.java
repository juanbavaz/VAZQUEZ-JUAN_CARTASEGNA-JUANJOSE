...
public class PacienteModificacionEntradaDto {
    ...
    public PacienteModificacionEntradaDto(Long id, String nombre, String apellido, Integer dni, LocalDate fechaDeIngreso, DomicilioModificacionEntradaDto domicilioModificacionEntradaDto) {
        this.id = id;
        this.nombre = nombre;
